...
class SiteAccess(Base):
    ...
    site_session_id = Column(Integer, ForeignKey("site_session.id"))  # Add ForeignKey
    ...
    site_session = relationship("SiteSession", back_populates="site_access")  # Add relationship